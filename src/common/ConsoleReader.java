...
public class ConsoleReader {
    ...
    public static String readWord() {
        ...
        if (!word.matches(REGEX_WORD))
            throw new InputMismatchException("Ввод не соответствует регулярному выражению \"" + REGEX_WORD + "\" (word).");
        return word;
    }
    ...
    public static String readSentence() {
        ...
        if (!sentence.matches(REGEX_SENTENCE))
            throw new InputMismatchException("Ввод не соответствует регулярному выражению \"" + REGEX_SENTENCE + "\" (sentence).");
        return sentence;
    }
